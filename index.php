      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav navbar-right">
            <button type="button" class="btn btn-warning navbar-btn" onclick="location.href='02-profile.php'">我的首頁</button>
    ...
    <div class="modal fade" id="logincontent" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body provision">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 jumbo-text">
                    <h1 class="tagline"><strong>好食刻</strong></h1>
                    <p class="lead"><strong>找美食、交朋友、當大廚、賺大錢</strong></p>
                    <a href="#" class="btn btn-warning btn-lg" id="login-btn" data-toggle="modal" data-target="#logincontent">Sign Up</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-4 panel-item">
                <div class="box">
                    <div class="box-heading">
                        <a href="01-bestselect.php"><img src="img/festive-food-1388406500q51.jpg"></a>
                    </div>
                    <div class="box-body">
                        <h3>編輯精選</h3>
                        <p>......<a href="01-bestselect.php">繼續閱讀</a></p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 panel-item">
                <div class="box">
                    <div class="box-heading">
                        <a href="01-bestchef.php"><img src="img/food-712665_960_720.jpg"></a>
                    </div>
                    <div class="box-body">
                        <h3>人氣大廚</h3>
                        <p>......<a href="01-bestchef.php">繼續閱讀</a></p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 panel-item">
                <div class="box">
                    <div class="box-heading">
                        <a href="01-localbest.php"><img src="img/Indonesian_Food.png"></a>
                    </div>
                    <div class="box-body">
                        <h3>區域美食</h3>
                        <p>......<a href="01-localbest.php">繼續閱讀</a></p>
                    </div>
                </div>
            </div>
        </div>
