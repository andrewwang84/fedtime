      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="01-bestchef.php">人氣大廚 <span class="sr-only">(current)</span></a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4 panel-item">
                <div class="box">
                    <div class="box-heading">
                        <img src="img/festive-food-1388406500q51.jpg">
                    </div>
                    <div class="box-body">
                        <h3>編輯精選</h3>
                        <p>......</p>
            ...
            <div class="col-sm-4 panel-item">
                <div class="box">
                    <div class="box-heading">
                        <img src="img/food-712665_960_720.jpg">
                    </div>
                    <div class="box-body">
                        <h3>人氣大廚</h3>
                        <p>......</p>
            ...
            <div class="col-sm-4 panel-item">
                <div class="box">
                    <div class="box-heading">
                        <img src="img/Indonesian_Food.png">
                    </div>
                    <div class="box-body">
                        <h3>區域美食</h3>
                        <p>......</p>
