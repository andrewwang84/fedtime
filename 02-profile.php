...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li><a href="01-bestselect.php">編輯精選 </a></li>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p><h4>五、系統中斷或故障<br/><br/></h4>
              ...
              您於使用本服務時宜自行採取防護措施。本網站對於您因使用（或無法使用）本服務而造成的損害，不負任何賠償責任。</p>

            <p><h4>六、不得為商業使用</h4>

              您同意並承諾不對本服務任何部分或本服務（包括但不限於會員內容、網站內容、軟體及會員帳號等）之使用或存取，進行任何商業目的之使用。</p>

            <p><h4>七、服務變更及通知</h4>

              您同意本網站保留於任何時間點，不經通知隨時修改、暫時或永久停止繼續提供本服務（或其任一部分）的權利。
              如依法或其他相關規定須為通知時，本服務得以包括但不限於：張貼於本服務網頁、電子郵件，或其他現在或未來合理之方式通知您，包括本服務條款之變更。但若您違反本服務條款，以未經授權的方式存取本服務，或於註冊時所提供之資料不正確或未更新，您將不會收到前述通知。當您經由授權的方式存取本服務，您即同意本服務所為之任何及所有給您的通知，均視為送達。</p>

            <p><h4>八、與第三方網站之連結及第三方提供之內容</h4>

              本服務可能會提供連結至其他網站或網路資源的連結。您可能會因此連結至其他業者經營的網站，
              但不表示本網站與該等業者有任何關係。其他業者經營的網站均由各該業者自行負責，不屬本網站控制及負責範圍之內。
              本網站對任何檢索結果或外部連結，不擔保其合適性、可依賴性、即時性、有效性、正確性及完整性。您也許會檢索或連結到一些令您厭惡或不需要的網站，這是網際網路運作的可能結果，遇到此類情形時，本網站建議您不要瀏覽或儘速離開該等網站。您並同意本網站無須為您連結至非屬於本網站之網站所生之任何損害，負損害賠償之責任。</p>

            <p><h4>九、隱私權保護政策之修正</h4>
    ...
    <div class="modal fade" id="start-cook" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <h3 class="modal-title" id="myModalLabel"><strong>開新飯局</strong></h4>
          </div>
          <div class="modal-body">
            <form class="form" role="form" method="post" action="">
              ...
              <div class="form-group">
                ...
                <input type="number" min="1" max="30" value="1" class="form-control" name="c_num" id="c_num">
              </div>
              <div class="form-group">
                <label for="start_t">開飯時間 :</label>
                <div class='input-group date' id='datetimepicker1'>
                    <input type='text' class="form-control" id='start_t' name="start_t" />
              ...
              <div class="form-group">
                <label for="loc_city">城市 :</label>
                <input type="text" class="form-control" id="loc_city" name="loc_city" placeholder="EX : 台北市東區">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <label class="checkbox-inline">
                  <input type="checkbox" value="0" name="tags[]"> 西餐
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="1" name="tags[]"> 義式
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="2" name="tags[]"> 台菜
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="3" name="tags[]"> 日式
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="4" name="tags[]"> 泰式
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="5" name="tags[]"> 越南
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="6" name="tags[]"> 港澳
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="7" name="tags[]"> 馬來菜
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="8" name="tags[]"> 印尼
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="9" name="tags[]"> 飯
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="10" name="tags[]"> 麵
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="11" name="tags[]"> 燒烤
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="12" name="tags[]"> 炸物
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="13" name="tags[]"> 素食
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="14" name="tags[]"> 甜點
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="15" name="tags[]"> 飲料
                </label>
                <label class="checkbox-inline">
                  <input type="checkbox" value="16" name="tags[]"> 調酒
                </label>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="s_pic">照片上傳</label>
                <input type="file" name="s_pic" enctype="multipart/form-data" id="s_pic">
              </div>
              <button type="submit" class="btn btn-default pull-right" id="newshop">送出</button>
              <button type="reset" value="重填" class="btn btn-warning pull-right">重填</button>
            </form>
          </div>
          <div class="modal-footer">
          </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-10">
                <h1 class="title">User的個人資料</h1>
                <hr>
                <p class="lead title">
                    用戶評價:&nbsp
                <span>★</span><span>★</span><span>★</span><span>☆</span><span>☆</span>
                <button type="button" class="btn btn-success pull-right" data-toggle="modal" data-target="#start-cook">開新飯局</button>
                <hr>
            </div>
            <div class="col-lg-1"></div>
        </div>
